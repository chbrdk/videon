<script lang="ts">
  ...
  import UdgGlassUnifiedTimeline from './udg-glass-unified-timeline.svelte';
...
<!-- Video Container -->
<div class="video-container glass-effect rounded-t-375 shadow-lg overflow-hidden aspect-video">
  <video
...
<!-- Timeline Container -->
            <div class="timeline-container glass-effect rounded-b-375 shadow-lg" style="position: relative; z-index: {showSearchModal ? -1 : 1};">
  <UdgGlassUnifiedTimeline 
    {scenes}
