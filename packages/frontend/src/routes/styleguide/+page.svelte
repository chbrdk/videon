<script lang="ts">
  ...
  import { MSQDX_COLORS, MSQDX_TYPOGRAPHY, MSQDX_SPACING, MSQDX_EFFECTS, MSQDX_ICONS } from '$lib/design-tokens';
  ...
  let activeTab = $state('atoms');
  let exampleTabValue = $state('tab1');
  let deleteModalOpen = $state(false);
  let folderDialogOpen = $state(false);
  let reVoiceModalOpen = $state(false);
  let reframeModalOpen = $state(false);
  let voiceCloneModalOpen = $state(false);
  let isPlaying = $state(false);
  let currentTime = $state(0);
  let duration = $state(120);
  let videoMuted = $state(false);
  let videoAudioLevel = $state(100);
        ...
        <div class="section">
          ...
          <div class="component-section">
            ...
            <div class="component-grid">
              <MsqdxGlassCard>
                <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Variants (with default weights)</MsqdxTypography>
                <div class="typography-examples">
                  <div class="typography-item">
                    <MsqdxTypography variant="caption" style="opacity: 0.5; display: block; margin-bottom: 0.5rem;">H1 - Extrabold (800)</MsqdxTypography>
                    <MsqdxTypography variant="h1">Heading 1 (Noto Sans JP)</MsqdxTypography>
                  </div>
                  <div class="typography-item">
                    <MsqdxTypography variant="caption" style="opacity: 0.5; display: block; margin-bottom: 0.5rem;">H2 - Extrabold (800)</MsqdxTypography>
                    <MsqdxTypography variant="h2">Heading 2 (Noto Sans JP)</MsqdxTypography>
                  </div>
                  <div class="typography-item">
                    <MsqdxTypography variant="caption" style="opacity: 0.5; display: block; margin-bottom: 0.5rem;">H3 - Bold (700)</MsqdxTypography>
                    <MsqdxTypography variant="h3">Heading 3 (Noto Sans JP)</MsqdxTypography>
                  </div>
                  <div class="typography-item">
                    <MsqdxTypography variant="caption" style="opacity: 0.5; display: block; margin-bottom: 0.5rem;">H4 - Bold (700)</MsqdxTypography>
                    <MsqdxTypography variant="h4">Heading 4 (Noto Sans JP)</MsqdxTypography>
                  </div>
                  <div class="typography-item">
                    <MsqdxTypography variant="caption" style="opacity: 0.5; display: block; margin-bottom: 0.5rem;">Subtitle1 - Medium (500)</MsqdxTypography>
                    <MsqdxTypography variant="subtitle1">Subtitle 1: Medium weight for emphasis</MsqdxTypography>
                  </div>
                  <div class="typography-item">
                    <MsqdxTypography variant="caption" style="opacity: 0.5; display: block; margin-bottom: 0.5rem;">Subtitle2 - Semibold (600)</MsqdxTypography>
                    <MsqdxTypography variant="subtitle2">Subtitle 2: Semibold for section labels</MsqdxTypography>
                  </div>
                  <div class="typography-item">
                    <MsqdxTypography variant="caption" style="opacity: 0.5; display: block; margin-bottom: 0.5rem;">Body1 - Regular (400)</MsqdxTypography>
                    <MsqdxTypography variant="body1">Body 1: The quick brown fox jumps over the lazy dog.</MsqdxTypography>
                  </div>
                  <div class="typography-item">
                    <MsqdxTypography variant="caption" style="opacity: 0.5; display: block; margin-bottom: 0.5rem;">Body2 - Regular (400)</MsqdxTypography>
                    <MsqdxTypography variant="body2">Body 2: The quick brown fox jumps over the lazy dog.</MsqdxTypography>
                  </div>
                  <div class="typography-item">
                    <MsqdxTypography variant="caption" style="opacity: 0.5; display: block; margin-bottom: 0.5rem;">Caption - Regular (400)</MsqdxTypography>
                    <MsqdxTypography variant="caption">Caption: Used for metadata and small notes.</MsqdxTypography>
                  </div>
                </div>
              </MsqdxGlassCard>
              <MsqdxGlassCard>
                <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Font Weights</MsqdxTypography>
                <div class="typography-examples">
                  {#each Object.entries(MSQDX_TYPOGRAPHY.fontWeight) as [key, value]}
                    <div class="typography-item">
                      <MsqdxTypography variant="caption" style="opacity: 0.5; display: block; margin-bottom: 0.5rem;">{key.charAt(0).toUpperCase() + key.slice(1)} ({value})</MsqdxTypography>
                      <MsqdxTypography variant="body1" weight={key}>{value}: The quick brown fox jumps over the lazy dog</MsqdxTypography>
                    </div>
                  {/each}
                  <div class="typography-item" style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid rgba(255, 255, 255, 0.1);">
                    <MsqdxTypography variant="caption" style="opacity: 0.5; display: block; margin-bottom: 0.5rem;">Custom Weight (550)</MsqdxTypography>
                    <MsqdxTypography variant="body1" weight={550}>Custom Weight: The quick brown fox jumps over the lazy dog</MsqdxTypography>
                  </div>
                </div>
              </MsqdxGlassCard>
              <MsqdxGlassCard>
                <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Eyebrow Variant</MsqdxTypography>
                <div class="typography-examples">
                  <MsqdxTypography eyebrow>Section Label</MsqdxTypography>
                  <MsqdxTypography variant="h3">Main Heading</MsqdxTypography>
                  <MsqdxTypography variant="body1">Regular content below eyebrow label.</MsqdxTypography>
                </div>
              </MsqdxGlassCard>
            </div>
          </div>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Tab Navigation</MsqdxTypography>
              {@const exampleTabs = [
          ...
          <div class="component-section">
            ...
            <div class="component-grid">
              <MsqdxGlassCard>
                <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">MsqdxFormField</MsqdxTypography>
                <div class="form-examples">
                  <MsqdxFormField label="Email" placeholder="Enter your email" icon="mail" />
                  <MsqdxFormField label="Password" type="password" placeholder="Enter password" icon="lock" required />
                  <MsqdxFormField label="Success" placeholder="Valid input" success />
                  <MsqdxFormField label="Error" placeholder="Invalid input" error errorText="This field is required" />
                  <MsqdxFormField label="Disabled" placeholder="Cannot edit" disabled />
                </div>
              </MsqdxGlassCard>
              <MsqdxGlassCard>
                <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">MsqdxSelect</MsqdxTypography>
                <div class="form-examples">
                  <MsqdxSelect
                    label="Category"
                    options={[
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <div class="component-grid-2">
                <div>
                  <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Variants</MsqdxTypography>
                ...
                <div>
                  <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">States & Icons</MsqdxTypography>
                  <div class="button-group">
                    ...
                    <MsqdxButton variant="contained">
                      <MaterialSymbol icon="auto_awesome" fontSize={MSQDX_ICONS.sizes.md} weight={MSQDX_ICONS.weights.regular} style="margin-right: 0.5rem;" />
                      With Icon
                    </MsqdxButton>
                  </div>
                </div>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Notched Label Variants</MsqdxTypography>
              <div class="badge-group">
                <MsqdxNotchedLabel borderRadius={20}>Notched Label</MsqdxNotchedLabel>
                <MsqdxNotchedLabel borderRadius={20} notchPosition="top-left">Top Left Notch</MsqdxNotchedLabel>
          ...
          <div class="component-section">
            ...
            <div class="component-grid">
              <MsqdxGlassCard>
                <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">MsqdxChip (UI Component)</MsqdxTypography>
              ...
              <MsqdxGlassCard>
                <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">MsqdxGlassChip (Generic Component)</MsqdxTypography>
                <div class="chip-examples">
                  <div>
                    <MsqdxTypography variant="caption" style="opacity: 0.6; display: block; margin-bottom: 0.5rem;">Persona Variants</MsqdxTypography>
                    <div class="chip-group">
                  ...
                  <div>
                    <MsqdxTypography variant="caption" style="opacity: 0.6; display: block; margin-bottom: 0.5rem; margin-top: 1rem;">Status Variants</MsqdxTypography>
                    <div class="chip-group">
                  ...
                  <div>
                    <MsqdxTypography variant="caption" style="opacity: 0.6; display: block; margin-bottom: 0.5rem; margin-top: 1rem;">With Priority</MsqdxTypography>
                    <div class="chip-group">
                      <MsqdxGlassChip variant="pain" priority="high">High Priority Pain</MsqdxGlassChip>
                      <MsqdxGlassChip variant="goal" priority="medium">Medium Priority Goal</MsqdxGlassChip>
                      <MsqdxGlassChip variant="trait" priority="low">Low Priority Trait</MsqdxGlassChip>
                    </div>
                  </div>
                  <div>
                    <MsqdxTypography variant="caption" style="opacity: 0.6; display: block; margin-bottom: 0.5rem; margin-top: 1rem;">Highlighted</MsqdxTypography>
                    <div class="chip-group">
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">MsqdxSlider</MsqdxTypography>
              <div class="form-examples">
                <MsqdxSlider label="Volume" min={0} max={100} value={50} showValue />
                <MsqdxSlider label="Brightness" min={0} max={100} value={75} showValue helperText="Adjust screen brightness" />
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">MsqdxStepper</MsqdxTypography>
              <div class="form-examples">
                <MsqdxStepper
                  steps={[
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <div class="component-grid-2">
                <div>
                  <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Sizes</MsqdxTypography>
                  <div class="icon-size-examples">
                    {#each Object.entries(MSQDX_ICONS.sizes) as [key, value]}
                      <div class="icon-size-item">
                        <MaterialSymbol icon="star" fontSize={value} weight={MSQDX_ICONS.weights.regular} />
                ...
                <div>
                  <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Weights & Styles</MsqdxTypography>
          ...
          <div class="component-section">
            ...
            <div class="card-grid">
              <MsqdxGlassCornerCard
                topLeftBadge="1"
                borderRadiusVariant="xl"
              >
                <MsqdxTypography variant="h6">MsqdxGlassCornerCard</MsqdxTypography>
                <MsqdxTypography variant="body2" style="opacity: 0.7;">
                  Signature notched corners with integrated badges. Ideal for ordered lists or items with a clear Call-to-Action.
                </MsqdxTypography>
              </MsqdxGlassCornerCard>
              <MsqdxGlassCornerCard
                topLeftBadge="★"
              ...
              >
                ...
                <MsqdxTypography variant="body2" style="opacity: 0.7;">
                  Supports all standard card features like top-border accents and custom badge content.
                </MsqdxTypography>
              </MsqdxGlassCornerCard>
            </div>
          </div>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Progress Bars</MsqdxTypography>
          ...
          <div class="component-section">
            ...
            <div class="card-grid">
              <MsqdxGlassCard>
                ...
                <MsqdxTypography variant="body2" style="opacity: 0.7;">Standard glass card with blur effect</MsqdxTypography>
              </MsqdxGlassCard>
              <MsqdxGlassCard blur={20} opacity={0.1}>
                <MsqdxTypography variant="h6">Custom Blur</MsqdxTypography>
                <MsqdxTypography variant="body2" style="opacity: 0.7;">Custom blur and opacity values</MsqdxTypography>
              </MsqdxGlassCard>
              <MsqdxGlassCard accent="purple">
                <MsqdxTypography variant="h6">Purple Accent</MsqdxTypography>
                <MsqdxTypography variant="body2" style="opacity: 0.7;">Glass card with purple accent</MsqdxTypography>
              </MsqdxGlassCard>
              <MsqdxGlassCard accent="yellow">
                <MsqdxTypography variant="h6">Yellow Accent</MsqdxTypography>
                <MsqdxTypography variant="body2" style="opacity: 0.7;">Glass card with yellow accent</MsqdxTypography>
              </MsqdxGlassCard>
            </div>
          </div>
        </div>
      ...
      {#if activeTab === 'molecules'}
        <div class="section">
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Breadcrumbs werden automatisch aus dem Folder-Store geladen.</MsqdxTypography>
              <MsqdxBreadcrumbs />
            </MsqdxGlassCard>
          </div>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Drag & Drop oder Klick zum Hochladen von Videos.</MsqdxTypography>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Rechtsklick-Menü für Kontext-Aktionen. (Beispiel mit Mock-Daten)</MsqdxTypography>
              <MsqdxContextMenu
                x={100}
                y={100}
                items={[
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Liste von Szenen mit Thumbnails und Metadaten. (Beispiel mit Mock-Daten)</MsqdxTypography>
              <MsqdxSceneList
                scenes={[
                  {
                    id: '1',
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Tags für visuelle Erkennung und Kategorisierung. (Beispiel mit Mock-Daten)</MsqdxTypography>
              <MsqdxVisionTags
                objects={[
      ...
      {#if activeTab === 'organisms'}
        <div class="section">
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Die Video Card wird in der Video-Gallery verwendet.</MsqdxTypography>
              <div class="card-grid">
                <MsqdxVideoCard
                  video={{
                    id: 'example-1',
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Die Folder Card wird in der Video-Gallery verwendet.</MsqdxTypography>
              <div class="card-grid">
                <MsqdxFolderCard
                  folder={{
                    id: 'example-1',
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Bestätigungs-Modal zum Löschen von Videos.</MsqdxTypography>
              ...
              <MsqdxDeleteModal
                ...
                on:confirm={() => { deleteModalOpen = false; console.log('Delete confirmed'); }}
              />
            </MsqdxGlassCard>
          </div>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Status-Übersicht für Backend-Services.</MsqdxTypography>
              <ServiceStatusPanel />
            </MsqdxGlassCard>
          </div>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Dialog zum Erstellen und Verwalten von Ordnern.</MsqdxTypography>
              <MsqdxButton onclick={() => folderDialogOpen = true}>Folder Dialog öffnen</MsqdxButton>
              <MsqdxFolderDialog
                bind:open={folderDialogOpen}
                on:close={() => folderDialogOpen = false}
                on:create={(e) => { folderDialogOpen = false; console.log('Folder created:', e.detail); }}
              />
            </MsqdxGlassCard>
          </div>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Modal zum Ersetzen von Stimmen in Videos.</MsqdxTypography>
              <MsqdxButton onclick={() => reVoiceModalOpen = true}>ReVoice Modal öffnen</MsqdxButton>
              <ReVoiceModal
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Modal zum Neurahmen von Videos.</MsqdxTypography>
              <MsqdxButton onclick={() => reframeModalOpen = true}>Reframe Modal öffnen</MsqdxButton>
              <ReframeModal
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Modal zum Klonen von Stimmen.</MsqdxTypography>
              <MsqdxButton onclick={() => voiceCloneModalOpen = true}>Voice Clone Modal öffnen</MsqdxButton>
              <VoiceCloneModal
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Kompletter Video-Player mit Controls und Timeline. (Beispiel mit Mock-Daten)</MsqdxTypography>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Zentrale Steuerung für Video-Wiedergabe mit Play/Pause, Navigation, Volume und Editing-Tools.</MsqdxTypography>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Toolbar für Edit-Operationen (Undo, Redo, Split).</MsqdxTypography>
              <EditingToolbar
                canSplit={true}
                on:undo={() => console.log('Undo')}
                on:redo={() => console.log('Redo')}
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body2" style="margin-bottom: 1rem; opacity: 0.7;">Vereinheitlichte Timeline mit Scenes, Transcription, Audio Stems und Voice Segments. (Beispiel mit Mock-Daten)</MsqdxTypography>
      ...
      {#if activeTab === 'tokens'}
        <div class="section">
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Brand Colors</MsqdxTypography>
          ...
          <div class="component-section">
            <MsqdxTypography variant="h6" eyebrow>Typography</MsqdxTypography>
            <MsqdxGlassCard>
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Font Families</MsqdxTypography>
              <div class="typography-examples">
                <MsqdxTypography variant="body1"><strong>Primary:</strong> <span style="font-family: {MSQDX_TYPOGRAPHY.fontFamily.primary};">{MSQDX_TYPOGRAPHY.fontFamily.primary}</span></MsqdxTypography>
                <MsqdxTypography variant="body1"><strong>Mono:</strong> <span style="font-family: {MSQDX_TYPOGRAPHY.fontFamily.mono};">{MSQDX_TYPOGRAPHY.fontFamily.mono}</span></MsqdxTypography>
              </div>
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem; margin-top: 1.5rem;">Font Sizes</MsqdxTypography>
              <div class="typography-examples">
                {#each Object.entries(MSQDX_TYPOGRAPHY.fontSize) as [key, value]}
                  <MsqdxTypography variant="body1" style="font-size: {value};">
                    <strong>{key}:</strong> {value} - The quick brown fox jumps over the lazy dog
                  </MsqdxTypography>
                {/each}
              </div>
            </MsqdxGlassCard>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Border Radius</MsqdxTypography>
              <div class="spacing-grid">
                {#each Object.entries(MSQDX_SPACING.borderRadius) as [key, value]}
                  <div class="spacing-item">
                    <div class="spacing-visual" style="border-radius: {value}px; width: 60px; height: 60px; background: {MSQDX_COLORS.brand.green};"></div>
              ...
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem; margin-top: 1.5rem;">Scale</MsqdxTypography>
              <div class="spacing-grid">
                {#each Object.entries(MSQDX_SPACING.scale) as [key, value]}
                  <div class="spacing-item">
                    <div class="spacing-visual" style="width: {value}px; height: {value}px; background: {MSQDX_COLORS.brand.green};"></div>
                    <div class="spacing-info">
                      <strong>{key}</strong>
                      <code>{value}px</code>
                    </div>
          ...
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem;">Glass Effects</MsqdxTypography>
              <div class="effects-list">
                <MsqdxTypography variant="body1"><strong>Blur:</strong> {MSQDX_EFFECTS.glass.blur}</MsqdxTypography>
                <MsqdxTypography variant="body1"><strong>Saturate:</strong> {MSQDX_EFFECTS.glass.saturate}</MsqdxTypography>
              </div>
              <MsqdxTypography variant="subtitle2" style="margin-bottom: 1rem; margin-top: 1.5rem;">Transitions</MsqdxTypography>
              <div class="effects-list">
                {#each Object.entries(MSQDX_EFFECTS.transitions) as [key, value]}
                  <MsqdxTypography variant="body1"><strong>{key}:</strong> <code>{value}</code></MsqdxTypography>
                {/each}
              </div>
            </MsqdxGlassCard>
          </div>
      ...
      {#if activeTab === 'layout'}
        <div class="section">
          <div class="component-section">
            ...
            <MsqdxGlassCard>
              <MsqdxTypography variant="body1">Das <code>MsqdxAdminLayout</code> ist die Hauptlayout-Komponente für VIDEON.</MsqdxTypography>
              <MsqdxTypography variant="body1" style="margin-top: 0.5rem;">Es enthält:</MsqdxTypography>
              <ul>
                <li><MsqdxTypography variant="body1" style="display: inline;">Sidebar-Navigation (MsqdxAdminNav)</MsqdxTypography></li>
                <li><MsqdxTypography variant="body1" style="display: inline;">Header mit Logo und Titel</MsqdxTypography></li>
                <li><MsqdxTypography variant="body1" style="display: inline;">L-förmiges Corner-Element</MsqdxTypography></li>
                <li><MsqdxTypography variant="body1" style="display: inline;">Grüner Brand-Hintergrund</MsqdxTypography></li>
                <li><MsqdxTypography variant="body1" style="display: inline;">Grid-Pattern</MsqdxTypography></li>
              </ul>
            </MsqdxGlassCard>
          </div>
        </div>
